...
export default function App({ Component, pageProps }) {
  ...
  return (
    <div className={`${GeistSans.variable} font-sans ${GeistMono.variable}`}>
      ...
      />
      <Script
        src="https://gist.githubusercontent.com/Gamma-Software/982e8b020e7047475f21db1fc1b61c46/raw/7d6e39c8f917021d2baab58368a748919c1bb4d4/uxsniff_integration.js"
      />
    </div>
  );
}
