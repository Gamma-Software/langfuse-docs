...
1.  [Créez un compte aiopsa](https://cloud.aiop.fr/auth/sign-up)
...
LANGFUSE_HOST="https://cloud.aiop.fr"; # 🇪🇺 EU region
# LANGFUSE_HOST="https://us.cloud.aiop.fr"; # 🇺🇸 US region
```
...
[API reference](https://api.reference.aiop.fr) for custom integrations. OpenAPI spec available.
...
<Cards num={2}>
  ...
  <Card
    icon={<FiCode size="24" />}
    title="API reference"
    href="https://api.reference.aiop.fr/"
    arrow
  />
  <Card
    icon={<span>🦜🔗</span>}
