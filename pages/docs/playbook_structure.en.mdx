...
- `inventory_config`: Inventory configuration. [Learn more](/docs/configurations/playbook#inventory).
- `inventory`: Inventory list. [Learn more](/docs/configurations/playbook#inventory).
- `playbook`: Playbook configuration. [Learn more](/docs/configurations/playbook#base).
- `packages`: Packages to build configuration. [En savoir plus](/docs/configurations/packages).
