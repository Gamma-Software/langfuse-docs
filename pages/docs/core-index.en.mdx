...
<Callout type="info" emoji="ℹ️">
  Originally, the goal of AIOP was to design packages for embedded applications. However, the solution was designed to be used in any other types of projects. If you have specific needs, do not hesitate to [contact us](/meeting).
</Callout>
...
<Callout emoji="🚨">
  It is important to note that Aiop does not correct errors for you ([this would happen sooner or later](/docs/roadmap)). It informs you of the errors and gives you indications on how to correct them. It is up to you to correct them.
</Callout>
...
[Learn more](/docs/configurations).

### Declarations

Aiop operates on the declarative principle of resources. Declarations are files that describe the artifacts of a package as well as their compatibilities with systems. [Learn more](/docs/declarations).
...
A multitude of other features and services will arrive in future versions (see the [roadmap](/docs/roadmap)). [Learn more](/docs/integrations).
