...
<Callout emoji="🚨">
  Il est important de noter que Aiop ne corrige pas les erreurs pour vous ([cela ne tarderait pas à se produire.](/docs/roadmap)). Il vous informe des erreurs et vous donne des indications pour les corriger. C'est à vous de les corriger.
</Callout>
...
Aiop fonctionne sur le principe déclaratif de ressources. Les déclarations sont des fichiers qui décrivent les artefacts d'un package ainsi que leurs compatibilités avec des systèmes. [En savoir plus](/docs/declarations).
...
Une multitude d'autres fonctionnalités et services arrivera dans les prochaines versions (voir la [feuille de route](/docs/roadmap)). [En savoir plus](/docs/integrations).
