...
Langfuse comes with a **list of predefined popular models and their tokenizers** including **OpenAI, Anthropic, Google**. Check out the [full list](https://cloud.aiop.fr/project/clkpwwm0m000gmm094odg11gi/models) (you need to sign-in).
