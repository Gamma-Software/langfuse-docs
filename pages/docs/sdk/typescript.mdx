...
LANGFUSE_BASEURL="https://cloud.aiop.fr"; # 🇪🇺 EU region
# LANGFUSE_BASEURL="https://us.cloud.aiop.fr"; # 🇺🇸 US region
```
...
const langfuse = new Langfuse({
  secretKey: "sk-lf-...",
  publicKey: "pk-lf-...",
  baseUrl: "https://cloud.aiop.fr", // 🇪🇺 EU region
  // baseUrl: "https://us.cloud.aiop.fr", // 🇺🇸 US region
...
| usage               | object | yes      | The usage object supports the OpenAi structure with (`promptTokens`, `completionTokens`, `totalTokens`) and a more generic version (`input`, `output`, `total`, `unit`, `inputCost`, `outputCost`, `totalCost`) where unit can be of value `"TOKENS"` (default) or `"CHARACTERS"`, `"MILLISECONDS"`, `"SECONDS"`, `"IMAGES"`. Refer to the docs on how to [automatically calculate](https://aiop.fr/docs/model-usage-and-cost) tokens and costs by Langfuse. |
