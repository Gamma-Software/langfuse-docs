...
All data in Langfuse is available via the GET API. Refer to the [API reference](https://api.reference.aiop.fr/) for more information.
...
<Frame>
  ...
  UI](https://static.aiop.fr/changelog-2023-09-18-export-generations.gif)
</Frame>
