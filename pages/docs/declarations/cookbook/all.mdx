...
Dans le cas où des les paramètres d’une cible déclaré dans l’inventaire sont tous compatibles avec une ressource, vous pouvez utiliser la valeur `all` pour déclarer la compatibilité avec tous les paramètres.
