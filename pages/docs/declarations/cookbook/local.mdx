...
Une ressource en local est une ressource qui est stockée dans le projet. Cela peut prendre la forme d'un fichier, d'un dossier, d'une image, d'un fichier de configuration, etc.
