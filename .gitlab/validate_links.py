...
# Function to get the broken hyperlinks from a URL
def is_broken_hyperlink(url):
...
def get_domain_hyperlinks(local_domain, url):
    ...
    for link in links:
        print(f"Checking broken link ({link}): {is_broken_hyperlink(link)}")
