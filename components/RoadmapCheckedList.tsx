...
const features: { name: string; checked: boolean }[] = [
    ...
    { name: "Récupération des resources à distance (Artifactory / Nexus)", checked: true },
    { name: "Mise en cache des resources distantes", checked: true },
    { name: "Dézipper une ressource", checked: true },
    { name: "Vérification de l’intégrité des resources installée d’Artifactory et de Nexus", checked: true },
